...
export default function App() {
  return (
    <ThemeProvider>
      <BrowserRouter>
        <div className="min-h-screen bg-[#FDFBF7] dark:bg-[#0A0E17] text-black dark:text-slate-100 flex flex-col selection:bg-brutal-yellow selection:text-black transition-colors duration-150">
          ...
          <div className="flex-1 flex overflow-hidden bg-[#FDFBF7] dark:bg-[#0A0E17]">
            <Sidebar />
            <main className="flex-1 overflow-y-auto bg-[#FDFBF7] dark:bg-[#0A0E17]">
              <Routes>
